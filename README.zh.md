...
braum/
├── packages/                    # 核心配置包
│   ├── commitlint/              # @braum/commitlint - 提交信息规范
│   ├── eslint/                  # @braum/eslint - ESLint 配置
│   ├── prettier/                # @braum/prettier - Prettier 配置
│   ├── stylelint/               # @braum/stylelint - Stylelint 配置
│   └── tsconfig/                # @braum/typescript-config - TypeScript 预设
├── tools/                       # 开发工具
│   └── cz/                      # @braum/cz - Commitizen 命令行工具
├── examples/                    # 示例项目
│   ├── eslint/                  # ESLint 使用示例
│   ├── react/                   # React 项目示例
