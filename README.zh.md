...
braum/
├── packages/                    # 核心配置包
│   ├── commitlint/              # @pixelastic-ai/commitlint - 提交信息规范
│   ├── eslint/                  # @pixelastic-ai/eslint - ESLint 配置
│   ├── prettier/                # @pixelastic-ai/prettier - Prettier 配置
│   ├── stylelint/               # @pixelastic-ai/stylelint - Stylelint 配置
│   └── tsconfig/                # @pixelastic-ai/typescript-config - TypeScript 预设
├── tools/                       # 开发工具
│   └── cz/                      # @pixelastic-ai/cz - Commitizen 命令行工具
├── examples/                    # 示例项目
│   ├── eslint/                  # ESLint 使用示例
│   ├── react/                   # React 项目示例
...
| 标签                       | 说明                  |
| -------------------------- | --------------------- |
| `@pixelastic-ai/eslint`            | ESLint 配置           |
| `@pixelastic-ai/prettier`          | Prettier 配置         |
| `@pixelastic-ai/stylelint`         | Stylelint 配置        |
| `@pixelastic-ai/commitlint`        | Commitlint 配置       |
| `@pixelastic-ai/cz`                | Commitizen 命令行工具 |
| `@pixelastic-ai/typescript-config` | TypeScript 配置预设   |
