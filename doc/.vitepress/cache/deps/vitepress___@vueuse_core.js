...
// node_modules/.pnpm/@vueuse+shared@14.0.0_vue@3.5.25_typescript@5.9.3_/node_modules/@vueuse/shared/dist/index.js
...
function increaseWithUnit(target, delta) {
  ...
  const value =
    ((_target$match = target.match(/^-?\d+\.?\d*/)) === null || _target$match === void 0 ? void 0 : _target$match[0]) ||
    ''
...
// node_modules/.pnpm/@vueuse+core@14.0.0_vue@3.5.25_typescript@5.9.3_/node_modules/@vueuse/core/dist/index.js
      ...
      useEventListener(
        ...
        event => {
          setTimeout(() => {
            ...
            const el = unrefElement(target)
            if (
              ((_window$document$acti = window$1.document.activeElement) === null || _window$document$acti === void 0
                ? void 0
...
function onLongPress(target, handler, options) {
  ...
  function onMove(ev) {
    ...
    if (
      ...
      ((_options$distanceThre = options === null || options === void 0 ? void 0 : options.distanceThreshold) !== null &&
    ...
    promise.value = new Promise((resolve, reject) => {
      try {
        ...
        if (_target == null) resolve('')
          ...
          const serialized = (
            (options === null || options === void 0 ? void 0 : options.serializer) || getDefaultSerialization(_target)
          )(_target)
...
function useCycleList(list, options) {
  ...
  const index = computed({
    get() {
      ...
      if (index$1 < 0)
        index$1 =
          (_options$fallbackInde = options === null || options === void 0 ? void 0 : options.fallbackIndex) !== null &&
      ...
      useEventListener(
        ...
        createFilterWrapper(eventFilter, event => {
          ...
          accelerationIncludingGravity.value = {
            x:
              ((_event$accelerationIn = event.accelerationIncludingGravity) === null || _event$accelerationIn === void 0
                ? void 0
...
function useDropZone(target, options = {}) {
  ...
  if (isClient) {
    ...
    const handleDragEvent = (event, eventType) => {
      ...
      isValid =
        (_ref = dataTransferItemList && checkValidity(dataTransferItemList)) !== null && _ref !== void 0 ? _ref : false
...
function useEventSource(url, events$1 = [], options = {}) {
  ...
  const _init = () => {
    ...
    es.onmessage = e => {
      ...
      event.value = null
      data.value =
        (_serializer$read = serializer.read(e.data)) !== null && _serializer$read !== void 0 ? _serializer$read : null
...
function useFavicon(newIcon = null, options = {}) {
  ...
  const applyIcon = icon => {
    const elements =
      document$1 === null || document$1 === void 0 ? void 0 : document$1.head.querySelectorAll(`link[rel*="${rel}"]`)
    ...
    if (payload) {
      ...
      if (config.payloadType)
        headers['Content-Type'] =
          (_payloadMapping$confi = payloadMapping[config.payloadType]) !== null && _payloadMapping$confi !== void 0
...
function useFileSystemAccess(options = {}) {
  ...
  const fileLastModified = computed(() => {
    ...
    return (_file$value$lastModif =
      (_file$value4 = file.value) === null || _file$value4 === void 0 ? void 0 : _file$value4.lastModified) !== null &&
      _file$value$lastModif !== void 0
...
function useScroll(element, options = {}) {
  ...
  function scrollTo(_x, _y) {
    ...
    const scrollContainer =
      (_element === null || _element === void 0 || (_document = _element.document) === null || _document === void 0
        ? void 0
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const state = reactive(
    useScroll(element, {
      ...
      offset: {
        [direction]:
          (_options$distance = options.distance) !== null && _options$distance !== void 0 ? _options$distance : 0,
        ...options.offset,
      },
    }),
  )
...
function useMemoize(resolver, options) {
  ...
  const generateKey = (...args) =>
    (options === null || options === void 0 ? void 0 : options.getKey) ? options.getKey(...args) : JSON.stringify(args)
...
function useTextareaAutosize(options = {}) {
  ...
  function triggerResize() {
    ...
    textareaScrollHeight.value =
      (_textarea$value = textarea.value) === null || _textarea$value === void 0 ? void 0 : _textarea$value.scrollHeight
...
function formatTimeAgo(from, options = {}, now2 = Date.now()) {
  ...
  if (typeof max === 'string') {
    var _units$find
    const unitMax =
      (_units$find = units.find(i => i.name === max)) === null || _units$find === void 0 ? void 0 : _units$find.max
...
function transition(source, from, to, options = {}) {
  ...
  return new Promise(resolve => {
    ...
    const tick = () => {
      var _options$abort
      if (
        (_options$abort = options.abort) === null || _options$abort === void 0 ? void 0 : _options$abort.call(options)
      ) {
        resolve()
        return
      }
...
function useUserMedia(options = {}) {
  ...
  const autoSwitch = shallowRef(
    (_options$autoSwitch = options.autoSwitch) !== null && _options$autoSwitch !== void 0 ? _options$autoSwitch : true,
  )
